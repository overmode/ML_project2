...
def to_cooc(path_vocab = 'vocab_full.pkl', path_tweets_pos = "clean_pos_bitri=True", path_tweets_neg = "clean_neg_bitri=True",path_tweets_test ="clean_test_bitri=True", dest = 'cooc_full.pkl'):
